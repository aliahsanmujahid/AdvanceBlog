...
def about(request):
    ...
    return render(request, 'front/about.html', {'trending':trending,'site':site, 'news':news, 'cat':cat, 'subcat':subcat, 'lastnews':lastnews, 'popnews2':popnews2, })
...
def contact(request):
    ...
    popnews2 = News.objects.all().order_by('-show')[:3]
    trending = Trending.objects.all().order_by('-pk')[:5]
    return render(request, 'front/contact.html' , {'trending':trending,'site':site, 'news':news, 'cat':cat, 'subcat':subcat, 'lastnews':lastnews, 'popnews2':popnews2})
